      ...
      <div className="container">
        ...
        <div className={styles.categoriesBox}>
          <div className={`${styles.categoriesGroup} ${styles.categoriesGroup3}`}>
            ...
            <Link href="" className={`${styles.category} ${styles.categoryMd}`}>
          ...
          <div className={`${styles.categoriesGroup} ${styles.categoriesGroup4}`}>
            <Link href="" className={`${styles.category}   ${styles.categorySm} row-start-1 col-start-1`}>
            ...
            <Link href="" className={`${styles.category}  ${styles.categorySm} row-start-2 col-start-1`}>
            ...
            <Link href="" className={`${styles.category} row-span-2 col-span-2`}>
          ...
          <div className={`${styles.categoriesGroup} ${styles.categoriesGroup3}`}>
            <Link href="" className={`${styles.category} col-span-2 row-start-1`}>
            ...
            <Link href="" className={`${styles.category}  ${styles.categoryMd} col-start-1 row-start-2`}>
            ...
            <Link href="" className={`${styles.category}  ${styles.categoryMd} col-start-1 row-start-3`}>
            ...
            <Link href="" className={`${styles.category} col-start-2 row-start-2 row-span-2`}>
          ...
          <div className={`${styles.categoriesGroup} ${styles.categoriesGroup4}`}>
            <Link href="" className={`${styles.category}  ${styles.categorySm}`}>
            ...
            <Link href="" className={`${styles.category} row-start-2 row-span-2`}>
